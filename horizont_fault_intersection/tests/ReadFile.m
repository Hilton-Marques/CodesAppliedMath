classdef ReadFile < handle
    properties
        m_filename
    end
    methods
        function this = ReadFile(filename)
            this.m_filename = filename;
        end
        function [vertices, faces] = getMesh(this)
            ...
            points = fgetl(fid);
            strs = ReadFile.splitchar(points);
